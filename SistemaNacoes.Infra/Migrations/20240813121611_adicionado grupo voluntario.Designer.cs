...
namespace SistemaNacoes.Infra.Migrations
{
    ...
    [Migration("20240813121611_adicionado grupo voluntario")]
    partial class adicionadogrupovoluntario
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SistemaNacoes.Domain.Entidades.GrupoVoluntario", b =>
                {
                    ...
                    b.HasOne("SistemaNacoes.Domain.Entidades.Voluntario", "Voluntario")
                        .WithOne("GrupoVoluntario")
                        .HasForeignKey("SistemaNacoes.Domain.Entidades.GrupoVoluntario", "VoluntarioId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();
